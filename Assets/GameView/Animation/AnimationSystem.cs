...
public abstract class AnimationSystem : IDestroyable
{
    ...
    public virtual void AddAnimated(IAnimationParams animationParamsBase)
    {
    ...
    public void RemoveAnimated(IAnimationParams animationParamsBase)
    {
        RemoveAnimated(animationParamsBase.Guid);
    }
...
{
    public override void AddAnimated(IAnimationParams ab)
    {
        if (ab is T abT)
            AddAnimated(abT);
        else
